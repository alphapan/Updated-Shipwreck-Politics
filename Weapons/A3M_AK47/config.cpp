...
class CfgWeapons
{
	...
	class A3M_AK_Norinco_base_F: Rifle_Base_F 
	{
		magazines[] = {A3M_30Rnd_762x39_AK}; /// original custom made magazines and a group of several standardized mags
...
/////////////////////////////////////////////////////  I R O N S I G H T S  /////////////////////////////////////////////////////
		...
		descriptionShort = "Norinco AK 47"; /// displayed on mouseOver in Inventory
...
//caseless ammo//
	...
	class A3M_AK47_Norinco: A3M_AK_Norinco_base_F
	{
		...
		displayName = "Norinco AK-47"; /// some name
		model = "\weapons\A3M_AK47\A3M_AK_Norinco2.p3d"; /// path to model
		picture = "\weapons\A3M_AK47\Data\UI\A3M_Ak47_co.paa"; /// different accessories have M, S, T instead of X
		UiPicture = "\weapons\A3M_AK47\Data\UI\A3M_Ak47_co.paa"; /// weapon with grenade launcher should be marked such way

		weaponInfoType = "RscWeaponZeroing"; /// display with zeroing is good for iron sights
		
		modes[] = {Single, single_medium_optics1, single_far_optics2,FullAuto, A3M_FullAuto_MRange, A3M_FullAuto_LRange};
